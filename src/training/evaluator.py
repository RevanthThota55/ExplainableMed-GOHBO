...
class Evaluator:
    ...
    def _plot_confusion_matrix(self):
        ...
        print(f"✓ Confusion matrices saved to {self.output_dir}")
    ...
    def _plot_roc_curves(self):
        ...
        print(f"✓ ROC curves saved to {self.output_dir}")
    ...
    def _plot_class_distribution(self):
        ...
        print(f"✓ Class distribution plot saved to {self.output_dir}")
    ...
    def _save_misclassified_samples(self):
        ...
        print(f"✓ Misclassified samples saved to {misclassified_path}")
